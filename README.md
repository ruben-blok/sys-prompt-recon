...
## Resources
* [**Model**](https://huggingface.co/ruben-blok/SysPromptRecon_V1_7B_Q4_K_M)
...
2. **Training:** A 7B model is trained to recognize patterns like reasoning blocks, documentation style, and code density to predict the original system prompt.
3. **Inference:** Run the fine-tuned model via Ollama to analyze any LLM output and guess its system prompt.
